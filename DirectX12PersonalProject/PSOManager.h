...
public:
	...
	void createPSO(DX12Core* core, std::string name, ID3DBlob* vs, ID3DBlob* ps, D3D12_INPUT_LAYOUT_DESC layout) {
		...
		const D3D12_RENDER_TARGET_BLEND_DESC defaultRenderTargetBlend = {
			FALSE, FALSE, D3D12_BLEND_ONE, D3D12_BLEND_ZERO,
	...
	void bind(DX12Core* core, std::string name) {
